...
def run_tool():
    ...
    final_fpath_iso = make_iso.move_isoids_from_genes(iso_dir, final_fpath_genes, arguments.iso_thr2,
                                                      arguments.iso_thr1, arguments.output_dir)
    trascripts_seq_fpath = extract_fasta.extract_fasta(arguments.ref_fasta, final_fpath_genes,
                                                      final_fpath_iso, arguments.output_dir)
    anno_draft_fpath = create_annot.create_gtf_file(final_fpath_iso, final_fpath_genes, arguments.output_dir,
                                                    option_parser.VERSION)
    orfipy_dir = create_annot.add_cds_into_anno(anno_draft_fpath, trascripts_seq_fpath,
                                                arguments.threads, arguments.output_dir)
    dirs_for_delete.add(orfipy_dir)
