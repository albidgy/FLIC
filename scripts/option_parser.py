...
def parser_arguments():
    ...
    general_args.add_argument('--nanopore_reads',
                              required=True,
                              help='Long reads in fastq or fastq.gz files separated by commas [Example: '
    ...
    general_args.add_argument('--ill_sites',
                              required=True,
                              help='Path to illumina splice sites file',
                              )
    ...
    general_args.add_argument('--make_downsampling',
                              default=False,
                              action='store_true',
                              help='Make a downsampling ONT reads by given threshold [default: False]',
                              )
    general_args.add_argument('--downsampling_max_thr',
                              default=1000,
                              type=int,
                              help='Number of reads per gene remaining after downsampling [default: 1000]',
                              )
    general_args.add_argument('--downsampling_min_thr',
                              default=5,
                              type=int,
    ...
    optional_args.add_argument('--thr1',  # '--n_reads_per_iso_thr_1st',
                               default=1,
                               type=int,
                               help='Minimum number of reads forming an isoform [default: 1]'
                               )
    optional_args.add_argument('--thr2',  # '--n_reads_per_iso_thr_2nd',
                               default=5,
                               type=int,
                               help='Minimum number of reads forming an isoform [default: 5]'
                               )
